...
TIME_CAPSULE="/home/pokho/dev/KCHNG/tests/regression/time_capsule_fixed_data.json"
...
echo "  Verification: Run bash /home/pokho/dev/KCHNG/tests/regression/verify_time_capsule.sh"
echo ""
